...
(* OASIS_START *)
(* DO NOT EDIT (digest: d01e0e3815983b0babdbfdde78a57ef4) *)
(*
...
let setup_t =
  {
       ...
       [
          ...
          ("test_dispatch",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_dispatch", []))];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)]
              })
       ];
            ...
            [
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "Build the example programs";
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Webmachine"];
                      lib_pack = false;
                      lib_internal_modules = ["Wm_util"];
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "hello_async.ml"});
               Executable
                 ({
                     cs_name = "hello_lwt";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "hello_lwt.ml"});
               Executable
                 ({
                     cs_name = "crud_lwt";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "crud_lwt.ml"});
               Executable
                 ({
                     cs_name = "test_logic";
                     cs_data = PropList.Data.create ();
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "test_dispatch.ml"});
               Test
                 ({
                     cs_name = "test_logic";
                     cs_data = PropList.Data.create ();
               ...
               SrcRepo
                 ({
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "https://github.com/inhabitedtype/ocaml-webmachine.git";
                      src_repo_browser =
                        Some
     ...
     oasis_version = "0.4.8";
     oasis_digest = Some "\223\239}=:l\250\204\172\248\182w+\164\127\029";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
